export default function Benefit() {
  return (
    <div className="flex flex-col gap-4 min-w-72 max-w-96 rounded">
      <h1 className="flex items-center gap-4 text-xl font-bold">
        <svg className="text-sky" width="50" height="50" viewBox="0 0 16 16">
          <path
            fill="currentColor"
      ...
      <p>
        ...
        maxime unde at officiis reprehenderit aperiam.
      </p>
    </div>
  );
}
